...
class ConversionDialog(QtWidgets.QDialog, Ui_conversion_dialog):
...
class MainGui(QtWidgets.QMainWindow, Ui_MainGuiWin):
    '''gui main class'''
    ...
    def __init__(self, parent=None):
        ...
        for spinner in self.findChildren((QtWidgets.QSpinBox, QtWidgets.QDoubleSpinBox)):
    ...
    def select_data_folder(self, path=''):
        ...
        if not path:
            ...
            self.fname = str(QtWidgets.QFileDialog.getExistingDirectory(caption=caption))
        else:
            self.fname = path
        ...
        if to_convert:
            ...
            progdialog = QtWidgets.QProgressDialog('converting image files..',
                                        'cancel',
    ...
    def export_results(self):
        ...
        out_folder = str(QtWidgets.QFileDialog.getExistingDirectory(caption=caption))
        ...
        progdialog = QtWidgets.QProgressDialog('export results..',
                                    'cancel',
    ...
    def preprocess(self):
        ...
        progdialog = QtWidgets.QProgressDialog('', 'cancel', 0, len(self.filelist), self)
        progdialog.setMinimumDuration(0)
        progdialog.setWindowModality(QtCore.Qt.WindowModal)
    ...
    def factorize(self):
        ...
        progdialog = QtWidgets.QProgressDialog('factorization going on ..',
                                            'cancel',
                                            0, len(self.filelist), self)
        progdialog.setMinimumDuration(0)
        progdialog.setWindowModality(QtCore.Qt.WindowModal)
